...
//                 <div>
//                     <p>Image Preview</p>
//                     <img className='rounded w-full h-52' src={imageUrl} alt='Image Preview'></img>
//                 </div>
//             </form>
...
const Formdisp = () => {
    return (
        <div className='lg:w-8/12 lg:h-full p-8 bg-teal-100  rounded-xl font-semibold '>
    ...
    const handleSignUp = async (userData) => {
        ...
        try {
            ...
            uploadImg(image)
                ...
                .catch(e => console.log("While uploading image from registration: ", e))




            const saveUser = (uid, img) => {
        ...
        <div className='h-full'>
            ...
            <form onSubmit={handleSubmit(handleSignUp)}>
                <div className='grid grid-cols-2 gap-2'>
                    ...
                    <div>
                        <p>Image Preview</p>
                        <img className='rounded-lg shadow-2xl w-full h-52' src={imageUrl} alt='Image Preview'></img>
                    </div>
